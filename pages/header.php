                            ...
                            <li>
                                ...
                                <ul class="menu">
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="../adminlte/dist/img/user3-128x128.jpg" class="img-circle"
                                                     alt="User Image">
                                            </div>
                                            <h4>
                                    ...
                                    <li>
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="../adminlte/dist/img/user4-128x128.jpg" class="img-circle"
                                                     alt="User Image">
                                            </div>
                                            <h4>
                                                Developers
            ...
            <ul class="sidebar-menu" data-widget="tree">
              ...
              <i class="fa fa-angle-left pull-right"></i>
                    ...
                    <ul class="treeview-menu">
                        <li class="active"><a href="../adminlte/index.html"><i class="fa fa-circle-o"></i> Dashboard v1</a>
                        </li>
              ...
              <span class="label label-primary pull-right">4</span>
                    ...
                    <ul class="treeview-menu">
                        <li><a href="../adminlte/pages/layout/top-nav.html"><i class="fa fa-circle-o"></i> Top
                                Navigation</a></li>
                        ...
                        <li><a href="../adminlte/pages/layout/collapsed-sidebar.html"><i class="fa fa-circle-o"></i>
